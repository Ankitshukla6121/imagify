...
const OnClickHandler= () =>{
 if(user){
  ...
  return (
    ...
    justify-center my-20 text-center'
     initial ={{opacity:0.2, y:100}} transition={{duration:1}} 
     whileInView={{opacity:1,y:0}} viewport={{once:true}}>

     <motion.div className='inline-flex gap-2 
     px-6 py-1 text-center bg-white border 
     rounded-full text-stone-500 border-neutral-500'
     initial ={{opacity:0, y:-20}}  
     animate={{opacity:1,y:0}} viewport={{once:true}}
   ...
   >
     ...
     mx-auto mt-10 text-center'  initial ={{opacity:0}}  
     animate={{opacity:1}} 
     transition={{delay : 0.4,duration:2}}> Turn text to <span className='text-blue-600' 
   ...
   >Unleash your creativity with AI, Turn imagination
